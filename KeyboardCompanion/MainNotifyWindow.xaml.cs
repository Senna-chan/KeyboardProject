...
namespace KeyboardCompanion
{
    ...
    public partial class MainNotifyWindow : Window
    {
        ...
        private void BtnOpenEditCreateMacroWindow_OnClick(object sender, RoutedEventArgs e)
        {
            new EditCreateMacro().Show();
        }

        private void CbxOperateMode_OnContextMenuClosing(object sender, ContextMenuEventArgs e)
        {
            ...
            if (msg == UsbNotification.WmDevicechange)
            {
                switch ((int)wparam)
                {
                    ...
                    case UsbNotification.DbtDevicearrival:
                        StartUp.FindComPort(); // Find keyboard Comport
                        break;
                }
            }
